...
GOOGLE_CLOUD_PROJECT = os.environ.get("GOOGLE_CLOUD_PROJECT") or "tmp"
GCS_BUCKET_NAME = os.environ.get("GCS_BUCKET_NAME") or "tmp"
GCP_PROJECT_NAME = os.environ.get("GCP_PROJECT_NAME") or "tmp"
...
def read_wav(
    ...
    # convert mono format (2-dim) into stereo format (1-dim)
    ...
    import platform
    if audio_sr != target_sr: # and 'Linux' not in platform.platform():
