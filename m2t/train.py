...
from m2t.data_modules import make_data_module, make_data_module_local
...
def train(
    ...
    if data_args.train_data_path.startswith("gs://"):
        data_module = make_data_module(tokenizer=tokenizer, data_args=data_args)
    else:
        data_module = make_data_module_local(tokenizer=tokenizer, data_args=data_args)
    ...
    # PEFT_MODEL = "wolfgangshen/llama2-7b-musicai_j0_multi"
    # model.push_to_hub(
